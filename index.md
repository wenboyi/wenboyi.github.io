...
My ongoing project focuses on individual differences in cortical oscillations and their role in auditory-motor coordination using hyperscanning EEG, ECG, and respiratory measurements. Beyond experimental work, I am also interested in developing new computational approaches to better quantify multimodal time series and clarify brain-body interactions.
